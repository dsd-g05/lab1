...
-- A[0]	=>  Location: PIN_B4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- B[0]	=>  Location: PIN_N4,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- B[2]	=>  Location: PIN_E2,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- A[1]	=>  Location: PIN_M6,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
ARCHITECTURE structure OF g05_comp6 IS
...
-- Equation(s):
-- \inst6~0_combout\ = (\A~combout\(2) & (\B~combout\(2) & (\B~combout\(0) $ (!\A~combout\(0))))) # (!\A~combout\(2) & (!\B~combout\(2) & (\B~combout\(0) $ (!\A~combout\(0)))))
...
-- Equation(s):
-- \inst6~1_combout\ = (\B~combout\(1) & (\A~combout\(1) & (\B~combout\(3) $ (!\A~combout\(3))))) # (!\B~combout\(1) & (!\A~combout\(1) & (\B~combout\(3) $ (!\A~combout\(3)))))
...
-- Equation(s):
-- \inst6~2_combout\ = (\B~combout\(5) & (\A~combout\(5) & (\A~combout\(4) $ (!\B~combout\(4))))) # (!\B~combout\(5) & (!\A~combout\(5) & (\A~combout\(4) $ (!\B~combout\(4)))))
...
-- Equation(s):
-- \inst6~3_combout\ = (\inst6~0_combout\ & (\inst6~1_combout\ & \inst6~2_combout\))
